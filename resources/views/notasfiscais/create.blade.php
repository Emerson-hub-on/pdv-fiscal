...
@section('conteudo')
<form id="form-nota" method="POST" action="{{ route('notasfiscais.store') }}" class="flex flex-col gap-6 max-w-5xl">
    @csrf
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-3 gap-4">
            <div>
                ...
                <select name="cliente_id" required class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm">
...
// Abre o editor de linha (qtd/valor/desconto/CFOP) — ainda não entra na grid
...
// Confirma a linha do editor e joga pra grid (array em memória, nada é salvo ainda)
...
// Serializa a grid pro campo oculto só na hora de enviar o formulário
